...
public class AtraksiAdapter extends BaseAdapter {

    Context c;
    ArrayList<DesaWisata> desaWisata;

    public AtraksiAdapter(Context c, ArrayList<DesaWisata> desaWisata) {
        this.c = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null){
            convertView = LayoutInflater.from(c).inflate(R.layout.atraksi_model, parent, false);
        }

...
public class KalenderDownloader extends AsyncTask<Void, Void, String> {
    ...
    public KalenderDownloader(Context c, String urlAddress, ListView lv) {
        this.c = c;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData == null){
            ...
            new KalenderParser(c, jsonData, lv).execute();
        }
    }

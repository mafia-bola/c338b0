...
public class KegiatanDownloader extends AsyncTask<Void, Void, String> {
    ...
    public KegiatanDownloader(Context c, String urlAddress, ListView lv) {
        this.c = c;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if (jsonData == null){
            ...
            new KegiatanParser(c, jsonData, lv).execute();
        }
    }
